...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BETWEEN_DATES, query = "SELECT m FROM Meal m WHERE m.user.id=:userId AND m.dateTime >= :startDate AND m.dateTime <=:endDate ORDER BY m.dateTime DESC"),
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String BETWEEN_DATES = "Meal.getBetween";
